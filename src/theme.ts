...
export const chatTheme: ChatTheme = {
  ...
  messages: {
    ...
    message: {
      ...
      question: [
        'relative font-semibold mb-4 px-4 py-4 pb-2 rounded-2xl rounded-br-none text-typography border bg-(--background-neutral-raised-5) border-(--stroke-neutral-5) text-gray-900'
      ].join(' '),
      response: [
  ...
  input: {
    ...
    input: [
      'w-full border px-3 py-2 pr-16 after:hidden after:mx-10! [&>textarea]:w-full [&>textarea]:flex-none [&>textarea]:outline-none [&>textarea]:resize-none'
    ].join(' '),
    actions: {
