  ...
  render: () => {
    ...
    return (
      <div className="w-[400px] space-y-4">
        <div className="p-4 bg-(--color-background-basic-white) dark:bg-(--color-background-basic-black) rounded-lg border border-stroke-neutral-4">
          <RichTextInput
        ...
        <div className="text-sm space-y-2">
          <div className="flex gap-2">
            <span className="text-content-text-neutral-2 w-20">onChange:</span>
            <code className="text-content-text-neutral-base bg-gradient-neutral-200 px-2 py-0.5 rounded flex-1 min-h-[24px]">
              {value || '(empty)'}
            </code>
          </div>
          <div className="flex gap-2">
            <span className="text-content-text-neutral-2 w-20">onSubmit:</span>
            <code className="text-content-text-neutral-base bg-gradient-neutral-200 px-2 py-0.5 rounded flex-1 min-h-[24px]">
